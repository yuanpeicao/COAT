...
# ccl.corr.final.obese[which(ccl.corr.obese.boot.binary < 85)] <- 0
# ccl.corr.final.lean <- res.ccl.lean$cor_w
# ccl.corr.final.lean[which(ccl.corr.lean.boot.binary < 85)] <- 0
# 
# reb.corr.final.obese <- res.reb.obese.boot$corr
# reb.corr.final.obese[which(reb.corr.obese.boot.binary < 85)] <- 0
# reb.corr.final.lean <- res.reb.lean.boot$corr
# reb.corr.final.lean[which(reb.corr.lean.boot.binary < 85)] <- 0
